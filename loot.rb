...
array = [["", ""], *service.get_spreadsheet_values(spreadsheet_id, "Sheet1!A2:A26").values.map{ |_,| [_.tr(" ", "_"), "+"] }].transpose +
  service.get_spreadsheet_values(spreadsheet_id, "Sheet1!Q1:AT1").values[0].zip(
    fill_for_transpose.call(
      service.get_spreadsheet(spreadsheet_id, include_grid_data: true, ranges: ["Sheet1!Q2:AT26"]).
