...
array = [["", ""], *service.get_spreadsheet_values(spreadsheet_id, "Sheet1!A2:A23").values.map{ |_,| [_.tr(" ", "_"), "+"] }].transpose +
  service.get_spreadsheet_values(spreadsheet_id, "Sheet1!B1:AQ1").values[0].zip(
    fill_for_transpose.call(
      service.get_spreadsheet(spreadsheet_id, include_grid_data: true, ranges: ["Sheet1!B2:AQ23"]).
